...
const galleries = {
    visites_guidees: [
        'images mediation/visite_guidee_1.png',
        'images mediation/visite_guidee_2.png',
        'images mediation/visite_guidee_3.png'
    ],
    amiens: [
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.projet-card').forEach(card => {
        card.addEventListener('click', function() {
                    // Si la carte a un data-link, rediriger vers la page
